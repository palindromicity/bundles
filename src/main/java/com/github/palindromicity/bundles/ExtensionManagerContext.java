...
import com.github.palindromicity.bundles.annotation.behavior.RequiresInstanceClassLoading;
import com.github.palindromicity.bundles.bundle.Bundle;
import com.github.palindromicity.bundles.bundle.BundleCoordinates;
import com.github.palindromicity.bundles.util.ImmutableCollectionUtils;
...
public class ExtensionManagerContext {
  ...
  public static class Builder {
     ...
     * @param classes {@code List} of {@code Class}
     * @return {@code Builder}
     */
     ...
     * @param systemBundle the top level {@code Bundle} for the system.
     * @return {@code Builder}
     */
     ...
     * @param bundles a set of {@code Bundles}
     * @return {@code Builder}
     */
     ...
     * explicitBundleToLoad, using the {@link FileSystemManager} and {@code BundleProperties}.
     ...
     * @return {@code ExtensionsManagerContext}
     * @throws IllegalArgumentException will be thrown if any of the SystemBundle, Classes, or Bundles
